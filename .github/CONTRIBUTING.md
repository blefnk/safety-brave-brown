...
- **GitHub Issues**: Utilize [GitHub Issues](https://github.com/blefnk/safety-brave-brown-nextjs-template/issues/new) for reporting bugs.
...
- **Existing Suggestions**: Search [GitHub Issues](https://github.com/blefnk/safety-brave-brown-nextjs-template/issues?q=) and our [Discord Suggestions Channel](https://discord.com/channels/1075533942096150598/1196425440777224212) to see if the suggestion has already been made.
...
1. **Issue Selection**: Choose an issue from [GitHub issues](https://github.com/blefnk/safety-brave-brown-nextjs-template/issues?q=) and request its assignment.
