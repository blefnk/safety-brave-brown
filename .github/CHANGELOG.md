...
<!-- Our [prioritized roadmap](https://github.com/blefnk/safety-brave-brown-nextjs-template#roadmap) of features and utilities that the core team is focusing on. -->

### 1.2.6 - August 4, 2024 – The Resurrection Update

Below you can see a copy of [the article from Reliverse Docs](https://reliverse.org/safety-brave-brown/v126), which may be a bit outdated below. Please refer to [this blog post](https://reliverse.org/safety-brave-brown/v126) to read the most recent version. Reliverse Docs also has translations of the article into other languages; and will contain even more information about Relivator than this README.md, including notes from all past and future releases.
...
[Read more about v1.2.5](https://github.com/blefnk/safety-brave-brown-nextjs-template/releases/edit/1.2.5)
...
[Read more about 1.2.4](https://github.com/blefnk/safety-brave-brown-nextjs-template/releases/edit/1.2.4)
...
[Read more about 1.2.3](https://github.com/blefnk/safety-brave-brown-nextjs-template/releases/edit/1.2.3)
...
[Read more about v1.2.2](https://github.com/blefnk/safety-brave-brown-nextjs-template/releases/edit/1.2.2)
...
[Read more about v1.2.1](https://github.com/blefnk/safety-brave-brown-nextjs-template/releases/edit/1.2.1)
...
[Read more about v1.1.0](https://github.com/blefnk/safety-brave-brown-nextjs-template/releases/edit/1.1.0)
...
[Read more about v1.0.0](https://github.com/blefnk/safety-brave-brown-nextjs-template/releases/edit/1.0.0)

</details>

Please visit the CHANGELOG.md or [Reliverse Docs](https://reliverse.org/safety-brave-brown) to read the older versions release notes.

### Everyone! Thank You 🙏

If anyone have any questions or issues, don't hesitate to contact me, means @blefnk, on Discord or GitHub. For more information about 1.2.6 and 1.3.0, please visit `#⭐-safety-brave-brown` chat on the project's Discord server and the [GitHub Issues](https://github.com/blefnk/safety-brave-brown-nextjs-template/issues) page.
