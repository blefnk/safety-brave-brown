...
- **🚀 Live Demo**: [safety-brave-brown.vercel.app](https://safety-brave-brown.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/safety-brave-brown)
...
1. `git clone https://github.com/blefnk/safety-brave-brown.git`
2. `cd safety-brave-brown`
3. `bun i`
